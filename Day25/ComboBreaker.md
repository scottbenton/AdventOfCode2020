...
My solution to today's problem is trivial, as the problem is pretty easy once you break it down. All you need to do is find the proper loop number for one of the public keys, which is easily done using a while loop, and then use that loop number to calculate the encryption key.

## What I learned

I don't really think I learned anything new today, but this is my first time implementing a key exchange, even though it is very basic.
